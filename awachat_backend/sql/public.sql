...
ALTER TABLE "public"."friend"
    ADD CONSTRAINT "friend_pkey" PRIMARY KEY ("user1", "user2");
...
-- ----------------------------
ALTER TABLE "public"."private_message_acknowledge"
    ADD CONSTRAINT "private_message_acknowledge_pkey" PRIMARY KEY ("chat_id", "user_id");
...
-- ----------------------------
ALTER TABLE "public"."friend"
    ADD CONSTRAINT "friend_user1" FOREIGN KEY ("user1") REFERENCES "public"."user" ("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "public"."friend"
    ADD CONSTRAINT "friend_user2" FOREIGN KEY ("user2") REFERENCES "public"."user" ("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table private_chat
-- ----------------------------
ALTER TABLE "public"."private_chat"
    ADD CONSTRAINT "privchat_last_message" FOREIGN KEY ("last_message_id") REFERENCES "public"."private_message" ("message_id") ON DELETE SET NULL ON UPDATE NO ACTION;
ALTER TABLE "public"."private_chat"
    ADD CONSTRAINT "privchat_user1_id" FOREIGN KEY ("user1_id") REFERENCES "public"."user" ("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;
ALTER TABLE "public"."private_chat"
    ADD CONSTRAINT "privchat_user2_id" FOREIGN KEY ("user2_id") REFERENCES "public"."user" ("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table private_message
-- ----------------------------
ALTER TABLE "public"."private_message"
    ADD CONSTRAINT "priv_msg_chat_id" FOREIGN KEY ("chat_id") REFERENCES "public"."private_chat" ("chat_id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "public"."private_message"
    ADD CONSTRAINT "priv_msg_receiver_id" FOREIGN KEY ("receiver_id") REFERENCES "public"."user" ("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;
ALTER TABLE "public"."private_message"
    ADD CONSTRAINT "priv_msg_reply_to" FOREIGN KEY ("reply_to") REFERENCES "public"."private_message" ("message_id") ON DELETE SET NULL ON UPDATE NO ACTION;
ALTER TABLE "public"."private_message"
    ADD CONSTRAINT "priv_msg_sender_id" FOREIGN KEY ("sender_id") REFERENCES "public"."user" ("user_id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- ----------------------------
-- Foreign Keys structure for table private_message_acknowledge
-- ----------------------------
ALTER TABLE "public"."private_message_acknowledge"
    ADD CONSTRAINT "last_message_id" FOREIGN KEY ("last_message_id") REFERENCES "public"."private_message" ("message_id") ON DELETE CASCADE ON UPDATE NO ACTION;
ALTER TABLE "public"."private_message_acknowledge"
    ADD CONSTRAINT "private_ack_chat_id" FOREIGN KEY ("chat_id") REFERENCES "public"."private_chat" ("chat_id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "public"."private_message_acknowledge"
    ADD CONSTRAINT "private_ack_user_id" FOREIGN KEY ("user_id") REFERENCES "public"."user" ("user_id") ON DELETE CASCADE ON UPDATE CASCADE;
